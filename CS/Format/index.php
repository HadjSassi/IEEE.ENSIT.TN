...
<head>
    ...
    <style>
        ...
        .joinus-header {
            background: linear-gradient(rgba(0, 0, 0, .1), rgba(0, 0, 0, .1)), url(/CS/Format/assets/bg.jpg) center center no-repeat;
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
            <a href="/index.html" class="navbar-brand d-lg-none">
                ...
                <img src="/img/logos/cs.png" alt="" width="150">
            </a>
...
<div class="container-fluid joinus-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center py-5" style="display: flex;align-items: center;justify-content: center;">
        ...
        <img alt = "" class="display-2 text-white mb-4 animated slideInDown" src="/img/logos/cswhite.png" style="width: 40%;"/>
    </div>
</div>
<!-- Page Header End -->
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="display-5 mb-5 ">PC Format Form</h1>
            ...
            <table class="fs-5 fw-medium mx-auto">
                <tr>
                    <td>Name: </td>
                    <td><strong>Computer Formatting</strong></td>
                </tr>
                <tr>
                    <td>Time: </td>
                    <td><strong>11 October 2023 14:00</strong></td>
                </tr>
                <tr>
                    <td>Class: </td>
                    <td><strong>A312</strong></td>
                </tr>
                <tr>
                    <td>Trainer: </td>
                    <td><strong>Ali Dorbez</strong></td>
                </tr>
            </table>
            <img class="mt-5" src="/CS/Format/assets/affiche.jpg" width="500" alt="">
        </div>
    </div>
</div>
<!-- overview End -->
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-6 mx-auto wow fadeInUp" data-wow-delay="0.1s">
                <form class="myform1" method="post" action="/CS/Format/joinus.php" onsubmit="replaceNewlines()">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="ieeeid" class="form-label">IEEE ID (If Exist!)</label>
                        <input type="text" class="form-control" id="ieeeid" name="ieeeid">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="field" id="field" class="form-select" required>
                            <option value="select">Select field of study</option>
                            <option value="Computer Engineering">Computer Engineering</option>
                            <option value="Industrial Engineering">Industrial Engineering</option>
                            <option value="Mathematics and Modeling">Mathematics and Modeling</option>
                            <option value="Electrical Engineering">Electrical Engineering</option>
                            <option value="Mechanical Engineering">Mechanical Engineering</option>
                            <option value="Civil Engineering">Civil Engineering</option>
                            <option value="Civil Engineering">Data Science Master</option>
                            <option value="Civil Engineering">Physique Master</option>
                        </select>
                    </div>

                    <div class="mb-3">
                        <label for="description" class="form-label">Anything to add or suggest?</label>
                        <textarea class="form-control" id="description" rows="3" name="other"></textarea>
                    </div>
...
<script src="/CS/Format/joinus.js"></script>
<script>
    function replaceNewlines() {
        const otherField = document.getElementById('description');

        otherField.value = otherField.value.replace(/ /g, '_');
        otherField.value = otherField.value.replace(/\n/g, ' -> ');
